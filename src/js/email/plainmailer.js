...
(function(factory) {
     ...
     */
    var PlainMailer = function(options, builder) {
        this._options = options;
        this._plainbuilder = builder || new PlainBuilder(options);
    };
    ...
    PlainMailer.prototype.send = function(options) {
        ...
        return Promise.resolve(self._plainbuilder.buildMimeTree(options))
        .then(function(obj) {
